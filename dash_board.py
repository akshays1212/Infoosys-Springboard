...
MODULE2_MODEL_PATH = os.path.join(BASE_DIR, "module2_trained_models", "lr_model.pkl")
MODULE3_MODEL_PATH = os.path.join(BASE_DIR, "module3_trained_models", "zero.pkl")
TFIDF_PATH = os.path.join(BASE_DIR, "module3_trained_models", "tfidf_vector.pkl")
