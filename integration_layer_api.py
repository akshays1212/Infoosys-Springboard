...
MODULE2_MODEL_PATH = os.path.join(BASE_DIR, "categorization_model", "lr_model.pkl")
MODULE3_MODEL_PATH = os.path.join(BASE_DIR, "urgency", "best_urgency_classifier.pkl")
TFIDF_PATH = os.path.join(BASE_DIR, "milestone_1", "tfidf_vector.pkl")
RULE_CONFIG_PATH = os.path.join(BASE_DIR, "urgency", "urgency_rule_config.json")
